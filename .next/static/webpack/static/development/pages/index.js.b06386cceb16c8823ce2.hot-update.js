  ...
  _createClass(Index, [{
    ...
    value: function renderChat() {
      var items = this.props.chatLog.map(function (string) {
        return {
          header: string,
          description: react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("h1", {
            __source: {
    ...
    value: function render() {
      return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("div", {
        ...
        __self: this
      }, "Chatroom Application"), this.renderChat());
    }
  }], [{
    key: "getInitialProps",
    value: function () {
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 18:
                ...
                _context.next = 21;
                return _ethereum_chatroom_js__WEBPACK_IMPORTED_MODULE_3__["default"].methods.getAuthor(_i + 1).call({
                  from: accounts[0]
                });
...
//# sourceMappingURL=index.js.b06386cceb16c8823ce2.hot-update.js.map